...
public class EnemyManager : MonoBehaviour
{
    ...
    [SerializeField]
    private Color gizmoColor = new Color(1, 0, 0, 0.3f); // 기즈모 색상 // 기즈모는 개발할 때 시각화가 필요한 부분들을 시각화 하는 것이다.
    ...
    public void Init(GameManager gameManager)//게임매니저 정보를 받는다.
    {
    ...
    {
        if (waveCount <= 0) //웨이브가 0이하면 오류니까 종료
        {
            gameManager.topDownGameManager.EndOfWave();
            return;
        }
